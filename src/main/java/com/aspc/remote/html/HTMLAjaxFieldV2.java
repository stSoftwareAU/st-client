...
//        page.addModule(AJAX_FIELD_MODULE_NAME);
    ...
    protected void setParent(final HTMLComponent parent) {
        ...
        if( parentPage != null)
        {
            parentPage.addModule(AJAX_FIELD_MODULE_NAME);
        }
    }
    ...
    protected void postCompile(ClientBrowser browser)
    {
        ...
        Object flag = page.getFlag(HTMLAjaxFieldV2.AJAX_FIELD_POST_COMPILED);
        if ("".equals(flag))
        {
            String dict = buildDataDictionary();
            page.addJavaScript(dict);
            page.putFlag(HTMLAjaxFieldV2.AJAX_FIELD_POST_COMPILED,AJAX_FIELD_POST_COMPILED);
        }
    }
